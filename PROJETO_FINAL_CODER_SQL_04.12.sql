...
-- Este script retorna o total de vendas de cada vendedor, incluindo o nome do vendedor e o valor total das vendas realizadas.
SELECT 
    v.nome_vendedor, 
    SUM(vd.valor_total) AS total_vendas
FROM 
    vendedores v
JOIN 
    vendas vd ON v.id_vendedor = vd.vendedor_id
GROUP BY 
    v.id_vendedor
ORDER BY 
    total_vendas DESC;
    
-- Este script retorna os 3 produtos mais vendidos com base na quantidade, mostrando o nome do produto, a quantidade vendida e a marca do produto.
SELECT 
    p.nome_produto, 
...
FROM 
    produtos p
JOIN 
    vendas vd ON p.id_produto = vd.produto_id
JOIN 
...
-- Este script retorna o total de vendas e a quantidade vendida por data, mostrando também o número de vendas realizadas em cada data.

SELECT 
    vd.data_venda,
    COUNT(vd.id_venda) AS numero_de_vendas,
    SUM(vd.quantidade) AS total_quantidade_vendida,
    SUM(vd.valor_total) AS valor_total_vendido
FROM 
    vendas vd
GROUP BY 
    vd.data_venda
...
-- Este script retorna as vendas em que o valor total da venda é superior a 100.000, incluindo o nome do vendedor, nome do produto, a data da venda e o valor total.
...
FROM 
    vendas vd
JOIN 
    vendedores v ON vd.vendedor_id = v.id_vendedor
JOIN 
    produtos p ON vd.produto_id = p.id_produto
WHERE 
    vd.valor_total > 100000
ORDER BY 
    vd.valor_total DESC;
    
-- Este script retorna os 3 vendedores que mais venderam em 2023, mostrando o nome do vendedor e o total de vendas realizadas durante o ano de 2023.
...
SELECT vw_vendas_por_produto FROM